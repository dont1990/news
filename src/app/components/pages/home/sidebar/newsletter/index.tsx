    ...
    <section className="py-6 relative overflow-hidden rounded-xl" dir="rtl">
      ...
      <Container className="relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          {/* Header */}
          <div className="mb-8">
            <div className="inline-flex items-center space-x-2 bg-secondary-500 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
              <Sparkles className="w-5 h-5 text-white" />
              <span className="text-white font-medium">به‌روز بمانید</span>
            </div>

            <p className="text-5xl py-2 font-bold mb-6 bg-gradient-to-r from-secondary-300 via-secondary to-secondary-300 bg-clip-text text-transparent">
