      ...
      <Container className="relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="max-w-md mx-auto">
            {isSubscribed ? (
              <div className="bg-primary-600/20 backdrop-blur-sm border border-primary-500/40 rounded-xl p-6 animate-in zoom-in duration-500">
              ...
              <form onSubmit={handleSubmit} className="space-y-4 relative">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="ps-10 pr-4 py-4 text-lg bg-transparent border border-primary text-gray-700 ring ring-primary placeholder:text-gray-500 rounded-xl focus:!ring-primary"
                    required
                  />
                </div>
                ...
                <Button
                  ...
                  size="lg"
                  disabled={loading}
                  className="w-full py-4 text-lg font-semibold hover:from-primary-600 hover:to-primary-600 rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-primary-500/25"
                >
