...
export default function TopNewspapersSwiper() {
  ...
  if (isLoading) return <p className="text-center mt-4 text-gray-500">در حال بارگذاری...</p>;
  if (error) return <p className="text-center mt-4 text-red-500">خطا در دریافت اطلاعات</p>;
